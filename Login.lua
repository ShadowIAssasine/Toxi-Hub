...
-- Global Variables
_G.Key = "ToxiHub-AdminAccess"
_G.KeyInput = ""
 
local function LoadToxiHub()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/ShadowIAssasine/Toxi-Hub/main/src/main/Toxi-Hub.lua"))() -- This function is now empty since all other content has been removed.
    orionlib:Destroy()
end
